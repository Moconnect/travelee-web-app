...
const BannerHeader = () => {
  return (
    <section className="relative bg-[url(https://images.pexels.com/photos/2174656/pexels-photo-2174656.jpeg)] bg-cover bg-center bg-no-repeat mb-20">
      <header className="">
        <div className="mx-auto px-16 ">
          <div className="flex h-16 items-center justify-between">
            <div className="md:flex md:items-center md:gap-12">
              <a className=" text-teal-600 flex gap-1" href="#">
                ...
                <h1 className="pt-2 text-white uppercase">travelee</h1>
              </a>
            </div>
